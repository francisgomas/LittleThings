...
namespace LittleThings.Server.Migrations
{
    ...
    [Migration("20220819214857_FileUploadModel")]
            ...
            modelBuilder.Entity("LittleThings.Shared.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fde20057-d3ff-42b7-80dc-8aaa6dfdc7d9"),
                            Name = "Shirts",
                            SubCategoryId = new Guid("6956be7a-c958-4d3d-a279-31260c303fc1")
                        });
                });
            ...
            modelBuilder.Entity("LittleThings.Shared.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6956be7a-c958-4d3d-a279-31260c303fc1"),
                            Name = "Mens"
                        });
                });
