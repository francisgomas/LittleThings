...
namespace LittleThings.Server.Migrations
{
    ...
    [Migration("20220821023440_AddRequiredToCatModel")]
    partial class AddRequiredToCatModel
    {
            ...
            modelBuilder.Entity("LittleThings.Shared.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0ef2ca8-7dc1-4bb2-8eff-1509d9d7d8ee"),
                            Image = "ss",
                            Name = "Shirts",
                            SubCategoryId = new Guid("a863c962-207f-4486-9c0c-6bbd95de18f2")
                        });
                });
            ...
            modelBuilder.Entity("LittleThings.Shared.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a863c962-207f-4486-9c0c-6bbd95de18f2"),
                            Name = "Mens"
                        });
                });
