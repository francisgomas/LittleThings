...
namespace LittleThings.Server.Migrations
{
    ...
    [Migration("20220904014903_UpdateProductTableFileUpload")]
    partial class UpdateProductTableFileUpload
    {
            ...
            modelBuilder.Entity("LittleThings.Shared.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("527f8e36-8fb1-4edb-ac65-9629e04abe5a"),
                            Name = "Mens"
                        });
                });

            modelBuilder.Entity("LittleThings.Shared.UploadResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
