...
namespace LittleThings.Server.Migrations
{
    ...
    [Migration("20220826122312_AddModelCartAndProduct")]
    partial class AddModelCartAndProduct
    {
            ...
            modelBuilder.Entity("LittleThings.Shared.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8facf81d-3832-42cd-ba14-f23449f4d250"),
                            ImageURL = "ss",
                            LinkUrl = "shirts",
                            Name = "Shirts",
                            SubCategoryId = new Guid("cd7d3973-6915-4e50-b900-b78a4509d2f4")
                        });
                });
            ...
            modelBuilder.Entity("LittleThings.Shared.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd7d3973-6915-4e50-b900-b78a4509d2f4"),
                            Name = "Mens"
                        });
                });
