...
namespace LittleThings.Server.Migrations
{
    ...
    [Migration("20221127073905_UpdateRoleClaimModel")]
    partial class UpdateRoleClaimModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LittleThings.Shared.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LittleThings.Shared.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("516cd5af-e015-4fbe-b517-0d44030ba9ad"),
                            Name = "Mens"
                        });
                });
