...
namespace LittleThings.Server.Migrations
{
    ...
    [Migration("20220820205101_CategoryModelUpdate")]
            ...
            modelBuilder.Entity("LittleThings.Shared.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fda92ff7-a150-49e1-856a-b329d7859996"),
                            FileUploadId = new Guid("adc6fe75-f713-4ad1-a324-74ba71003319"),
                            Name = "Shirts",
                            SubCategoryId = new Guid("99a6b30d-1961-4441-80d8-b9bded0d602a")
                        });
                });
            ...
            modelBuilder.Entity("LittleThings.Shared.FileUpload", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("adc6fe75-f713-4ad1-a324-74ba71003319"),
                            ErrorCode = 0,
                            FileName = "xyz",
                            StoredFileName = "xyz",
                            Uploaded = true
            ...
            modelBuilder.Entity("LittleThings.Shared.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("99a6b30d-1961-4441-80d8-b9bded0d602a"),
                            Name = "Mens"
                        });
                });
